!(function () {
    ...
    function i(e) {
        var n = { className: "variable", variants: [{ begin: /\$[\w\d#@][\w\d_]*/ }, { begin: /\$\{(.*?)}/ }] },
            a = { className: "string", begin: /"/, end: /"/, contains: [e.BACKSLASH_ESCAPE, n, { className: "variable", begin: /\$\(/, end: /\)/, contains: [e.BACKSLASH_ESCAPE] }] };
        return {
            aliases: ["sh", "zsh"],
            lexemes: /\b-?[a-z\._]+\b/,
            keywords: {
    ...
    function s(e) {
        ...
        return (g.contains = [e.COMMENT("comment", ""), u, n]), (n.contains = a), (l.contains = a), (c.contains = [l]), { aliases: ["clj"], illegal: /\S/, contains: [g, i, o, c, s, d, l, t, r] };
    }
    function r(e) {
        function n(e) {
            return "(?:" + e + ")?";
        ...
        var a = "decltype\\(auto\\)",
            t = (n((g = "[a-zA-Z_]\\w*::")), n("<.*?>"), { className: "keyword", begin: "\\b[a-z\\d_]*_t\\b" }),
            i = {
                className: "string",
                variants: [
            ...
            l = { className: "title", begin: n(g) + e.IDENT_RE, relevance: 0 },
            o = n(g) + e.IDENT_RE + "\\s*\\(",
            c = {
                keyword:
            ...
            g = {
                ...
                keywords: c,
                contains: d.concat([{ begin: /\(/, end: /\)/, keywords: c, contains: d.concat(["self"]), relevance: 0 }]),
                relevance: 0,
            },
            s = {
                className: "function",
                begin: "((decltype\\(auto\\)|(?:[a-zA-Z_]\\w*::)?[a-zA-Z_]\\w*(?:<.*?>)?)[\\*&\\s]+)+" + o,
                returnBegin: !0,
                end: /[{;=]/,
                excludeEnd: !0,
                keywords: c,
                ...
                contains: [
                    ...
                    { begin: o, returnBegin: !0, contains: [l], relevance: 0 },
                    {
                        ...
                        keywords: c,
                        relevance: 0,
                        contains: [e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, i, s, t, { begin: /\(/, end: /\)/, keywords: c, relevance: 0, contains: ["self", e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, i, s, t] }],
                    },
                    t,
        ...
        return {
            ...
            keywords: c,
            illegal: "</",
            contains: [].concat(g, s, d, [
                r,
                { begin: "\\b(deque|list|queue|stack|vector|map|set|bitset|multiset|multimap|unordered_map|unordered_set|unordered_multiset|unordered_multimap|array)\\s*<", end: ">", keywords: c, contains: ["self", t] },
    ...
    function l(e) {
        var n = {
            ...
            o = { className: "string", begin: /\$@"/, end: '"', contains: [{ begin: "{{" }, { begin: "}}" }, { begin: '""' }, s] },
            c = e.inherit(o, { illegal: /\n/, contains: [{ begin: "{{" }, { begin: "}}" }, { begin: '""' }, r] });
        return (
            (s.contains = [o, l, t, e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, a, e.C_BLOCK_COMMENT_MODE]),
            ...
            (t = e.IDENT_RE + "(<" + e.IDENT_RE + "(\\s*,\\s*" + e.IDENT_RE + ")*>)?(\\[\\])?"),
            {
                ...
                illegal: /::/,
                contains: [
                    e.COMMENT("///", "$", { returnBegin: !0, contains: [{ className: "doctag", variants: [{ begin: "///", relevance: 0 }, { begin: "\x3c!--|--\x3e" }, { begin: "</?", end: ">" }] }] }),
                    e.C_LINE_COMMENT_MODE,
                    e.C_BLOCK_COMMENT_MODE,
                    ...
                    { beginKeywords: "namespace", end: /[{;=]/, illegal: /[^\s:]/, contains: [e.inherit(e.TITLE_MODE, { begin: "[a-zA-Z](\\.?\\w)*" }), e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE] },
                    ...
                    { beginKeywords: "new return throw await else", relevance: 0 },
                    {
                        ...
                        contains: [
                            ...
                            { className: "params", begin: /\(/, end: /\)/, excludeBegin: !0, excludeEnd: !0, keywords: n, relevance: 0, contains: [l, a, e.C_BLOCK_COMMENT_MODE] },
                            e.C_LINE_COMMENT_MODE,
                            e.C_BLOCK_COMMENT_MODE,
                        ],
                    },
    ...
    function c(e) {
        return {
            ...
            contains: [
                ...
                { className: "comment", variants: [{ begin: /Index: /, end: /$/ }, { begin: /={3,}/, end: /$/ }, { begin: /^\-{3}/, end: /$/ }, { begin: /^\*{3} /, end: /$/ }, { begin: /^\+{3}/, end: /$/ }, { begin: /^\*{15}$/ }] },
    ...
    function d(e) {
        return {
            ...
            contains: [e.HASH_COMMENT_MODE, e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, e.NUMBER_MODE, { beginKeywords: "run cmd entrypoint volume add copy workdir label healthcheck shell", starts: { end: /[^\\]$/, subLanguage: "bash" } }],
            illegal: "</",
        };
    }
    function g(e) {
        var n = "[a-zA-Z_][a-zA-Z0-9_.]*(\\!|\\?)?",
            ...
            l = { className: "function", beginKeywords: "def defp defmacro", end: /\B\b/, contains: [e.inherit(e.TITLE_MODE, { begin: n, endsParent: !0 })] },
            o = e.inherit(l, { className: "class", beginKeywords: "defimpl defmodule defprotocol defrecord", end: /\bdo\b|$|;/ }),
            e = [
                r,
                s,
                i,
                ...
                l,
                { begin: "::" },
                { className: "symbol", begin: ":(?![\\s:])", contains: [r, { begin: "[a-zA-Z_]\\w*[!?=]?|[-+~]\\@|<<|>>|=~|===?|<=>|[<>]=?|\\*\\*|[-/+%^&*~`|]|\\[\\]=?" }], relevance: 0 },
                { className: "symbol", begin: n + ":(?!:)", relevance: 0 },
                { className: "number", begin: "(\\b0o[0-7_]+)|(\\b0b[01_]+)|(\\b0x[0-9a-fA-F_]+)|(-?\\b[1-9][0-9_]*(.[0-9_]+([eE][-+]?[0-9]+)?)?)", relevance: 0 },
    ...
    function u(e) {
        ...
        return {
            ...
            contains: [
                ...
                { begin: /:=/ },
                { className: "function", beginKeywords: "func", end: "\\s*(\\{|$)", excludeEnd: !0, contains: [e.TITLE_MODE, { className: "params", begin: /\(/, end: /\)/, keywords: n, illegal: /["']/ }] },
            ],
        };
    }
    function m(e) {
        return {
            ...
            contains: [
                ...
                { className: "class", beginKeywords: "class interface trait enum", end: "{", illegal: ":", contains: [{ beginKeywords: "extends implements" }, e.UNDERSCORE_TITLE_MODE] },
                e.C_NUMBER_MODE,
    ...
    function _(e) {
        var n = { variants: [e.COMMENT("--", "$"), e.COMMENT("{-", "-}", { contains: ["self"] })] },
            ...
            s = { begin: "\\(", end: "\\)", illegal: '"', contains: [a, t, { className: "type", begin: "\\b[A-Z][\\w]*(\\((\\.\\.|,|\\w+)\\))?" }, e.inherit(e.TITLE_MODE, { begin: "[_a-z][\\w']*" }), n] };
        return {
            aliases: ["hs"],
            keywords:
            ...
            contains: [
                { beginKeywords: "module", end: "where", keywords: "module where", contains: [s, n], illegal: "\\W\\.|;" },
                { begin: "\\bimport\\b", end: "$", keywords: "import qualified as hiding", contains: [s, n], illegal: "\\W\\.|;" },
                { className: "class", begin: "^(\\s*)?(class|instance)\\b", end: "where", keywords: "class family instance where", contains: [i, s, n] },
                { className: "class", begin: "\\b(data|(new)?type)\\b", end: "$", keywords: "data family type newtype deriving", contains: [a, i, s, { begin: "{", end: "}", contains: s.contains }, n] },
                { beginKeywords: "default", end: "$", contains: [i, s, n] },
                { beginKeywords: "infix infixl infixr", end: "$", contains: [e.C_NUMBER_MODE, n] },
                { begin: "\\bforeign\\b", end: "$", keywords: "foreign import export ccall stdcall cplusplus jvm dotnet safe unsafe", contains: [i, e.QUOTE_STRING_MODE, n] },
    ...
    function b(e) {
        ...
        return {
            ...
            contains: [
                ...
                e.APOS_STRING_MODE,
                e.QUOTE_STRING_MODE,
                { className: "class", beginKeywords: "class interface", end: /[{;=]/, excludeEnd: !0, keywords: "class interface", illegal: /[:"\[\]]/, contains: [{ beginKeywords: "extends implements" }, e.UNDERSCORE_TITLE_MODE] },
                { beginKeywords: "new throw return else", relevance: 0 },
                {
                    className: "function",
                    begin: "([Ã€-Ê¸a-zA-Z_$][Ã€-Ê¸a-zA-Z_$0-9]*(<[Ã€-Ê¸a-zA-Z_$][Ã€-Ê¸a-zA-Z_$0-9]*(\\s*,\\s*[Ã€-Ê¸a-zA-Z_$][Ã€-Ê¸a-zA-Z_$0-9]*)*>)?\\s+)+" + e.UNDERSCORE_IDENT_RE + "\\s*\\(",
                    returnBegin: !0,
                    end: /[{;=]/,
                    excludeEnd: !0,
                    keywords: n,
                    contains: [
                        ...
                        { className: "params", begin: /\(/, end: /\)/, keywords: n, relevance: 0, contains: [e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, e.C_NUMBER_MODE, e.C_BLOCK_COMMENT_MODE] },
                        e.C_LINE_COMMENT_MODE,
                        e.C_BLOCK_COMMENT_MODE,
                    ],
                },
    ...
    function p(e) {
        var n = "<>",
            ...
            r = { className: "number", variants: [{ begin: "\\b(0[bB][01]+)n?" }, { begin: "\\b(0[oO][0-7]+)n?" }, { begin: e.C_NUMBER_RE + "n?" }], relevance: 0 },
            l = { className: "subst", begin: "\\$\\{", end: "\\}", keywords: s, contains: [] },
            o = { begin: "html`", end: "", starts: { end: "`", returnEnd: !1, contains: [e.BACKSLASH_ESCAPE, l], subLanguage: "xml" } },
            c = { begin: "css`", end: "", starts: { end: "`", returnEnd: !1, contains: [e.BACKSLASH_ESCAPE, l], subLanguage: "css" } },
            d = { className: "string", begin: "`", end: "`", contains: [e.BACKSLASH_ESCAPE, l] };
        return (
            (l.contains = [e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, o, c, d, r, e.REGEXP_MODE]),
            (l = l.contains.concat([e.C_BLOCK_COMMENT_MODE, e.C_LINE_COMMENT_MODE])),
            {
                ...
                contains: [
                    ...
                    e.C_BLOCK_COMMENT_MODE,
                    r,
                    { begin: /[{,\n]\s*/, relevance: 0, contains: [{ begin: i + "\\s*:", returnBegin: !0, relevance: 0, contains: [{ className: "attr", begin: i, relevance: 0 }] }] },
                    {
                        ...
                        contains: [
                            ...
                            e.REGEXP_MODE,
                            {
                                ...
                                contains: [{ className: "params", variants: [{ begin: i }, { begin: /\(\s*\)/ }, { begin: /\(/, end: /\)/, excludeBegin: !0, excludeEnd: !0, keywords: s, contains: l }] }],
                            },
                    ...
                    },
                    {
                        ...
                        excludeEnd: !0,
                        contains: [e.inherit(e.TITLE_MODE, { begin: i }), { className: "params", begin: /\(/, end: /\)/, excludeBegin: !0, excludeEnd: !0, contains: l }],
                        illegal: /\[|%/,
                    },
                    { begin: /\$[(.]/ },
                    e.METHOD_GUARD,
    ...
    function f(e) {
        var n = { literal: "true false null" },
            ...
            s = { begin: "{", end: "}", contains: [{ className: "attr", begin: /"/, end: /"/, contains: [e.BACKSLASH_ESCAPE], illegal: "\\n" }, e.inherit(i, { begin: /:/ })].concat(a), illegal: "\\S" },
    ...
    function E(e) {
        var n = {
            ...
            i = {
                className: "string",
                variants: [
                    { begin: '"""', end: '"""(?=[^"])', contains: [(c = { className: "variable", begin: "\\$" + e.UNDERSCORE_IDENT_RE }), t] },
                    { begin: "'", end: "'", illegal: /\n/, contains: [e.BACKSLASH_ESCAPE] },
                    { begin: '"', end: '"', illegal: /\n/, contains: [e.BACKSLASH_ESCAPE, c, t] },
                ],
            };
        t.contains.push(i);
        var s = { className: "meta", begin: "@(?:file|property|field|get|set|receiver|param|setparam|delegate)\\s*:(?:\\s*" + e.UNDERSCORE_IDENT_RE + ")?" },
            r = { className: "meta", begin: "@" + e.UNDERSCORE_IDENT_RE, contains: [{ begin: /\(/, end: /\)/, contains: [e.inherit(i, { className: "meta-string" })] }] },
            l = {
                className: "number",
                begin: "\\b(0[bB]([01]+[01_]+[01]+|[01]+)|0[xX]([a-fA-F0-9]+[a-fA-F0-9_]+[a-fA-F0-9]+|[a-fA-F0-9]+)|(([\\d]+[\\d_]+[\\d]+|[\\d]+)(\\.([\\d]+[\\d_]+[\\d]+|[\\d]+))?|\\.([\\d]+[\\d_]+[\\d]+|[\\d]+))([eE][-+]?\\d+)?)[lLfF]?",
                relevance: 0,
                    ...
                    r,
                    {
                        ...
                        contains: [
                            ...
                            { className: "type", begin: /</, end: />/, keywords: "reified", relevance: 0 },
                            {
                                ...
                                keywords: n,
                                relevance: 0,
                                contains: [{ begin: /:/, end: /[=,\/]/, endsWithParent: !0, contains: [c, e.C_LINE_COMMENT_MODE, o], relevance: 0 }, e.C_LINE_COMMENT_MODE, o, s, r, i, e.C_NUMBER_MODE],
                            },
                            o,
                        ],
                    },
    ...
    function N(e) {
        return {
            ...
            contains: [
                ...
                { className: "code", variants: [{ begin: "^```\\w*\\s*$", end: "^```[ ]*$" }, { begin: "`.+?`" }, { begin: "^( {4}|\\t)", end: "$", relevance: 0 }] },
                { begin: "^[-\\*]{3,}", end: "$" },
                {
                    begin: "\\[.+?\\][\\(\\[].*?[\\)\\]]",
                    returnBegin: !0,
    ...
    function h(e) {
        var n = { keyword: "rec with let in inherit assert if else then", literal: "true false or and null", built_in: "import abort baseNameOf dirOf isNull builtins map removeAttrs throw toString derivation" },
            ...
            t = [e.NUMBER_MODE, e.HASH_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, t, { begin: /[a-zA-Z0-9-_]+(\s*=)/, returnBegin: !0, relevance: 0, contains: [{ className: "attr", begin: /\S+/ }] }];
        return { aliases: ["nixos"], keywords: n, contains: (a.contains = t) };
    }
    function v(e) {
        ...
        return {
            ...
            contains: [
                ...
                { className: "class", begin: "(" + a.split(" ").join("|") + ")\\b", end: "({|$)", excludeEnd: !0, keywords: a, lexemes: n, contains: [e.UNDERSCORE_TITLE_MODE] },
    ...
    function y(e) {
        var n =
            ...
            a = { className: "subst", begin: "[$@]\\{", end: "\\}", keywords: n },
            t = { begin: "->{", end: "}" },
            i = { variants: [{ begin: /\$\d/ }, { begin: /[\$%@](\^\w\b|#\w+(::\w+)*|{\w+}|\w+(::\w*)*)/ }, { begin: /[\$%@][^\s\w{]/, relevance: 0 }] },
    ...
    function w(e) {
        var n = { begin: "\\$+[a-zA-Z_-Ã¿][a-zA-Z0-9_-Ã¿]*" },
        ...
        return {
            ...
            contains: [
                ...
                { begin: /(::|->)+[a-zA-Z_\x7f-\xff][a-zA-Z0-9_\x7f-\xff]*/ },
                {
                    ...
                    excludeEnd: !0,
                    illegal: "\\$|\\[|%",
                    contains: [e.UNDERSCORE_TITLE_MODE, { className: "params", begin: "\\(", end: "\\)", contains: ["self", n, e.C_BLOCK_COMMENT_MODE, t, i] }],
                },
    ...
    function O(e) {
        ...
        return {
            ...
            contains: [
                e.COMMENT("^\\s*[!#]", "$"),
                { begin: t + a, returnBegin: !0, contains: [{ className: "attr", begin: t, endsParent: !0, relevance: 0 }], starts: s },
                { begin: i + a, returnBegin: !0, relevance: 0, contains: [{ className: "meta", begin: i, endsParent: !0, relevance: 0 }], starts: s },
    ...
    function C(e) {
        var n = "[a-zA-Z_]\\w*[!?=]?|[-+~]\\@|<<|>>|=~|===?|<=>|[<>]=?|\\*\\*|[-/+%^&*~`|]|\\[\\]=?",
            ...
            i = { begin: "#<", end: ">" },
            s = [e.COMMENT("#", "$", { contains: [t] }), e.COMMENT("^\\=begin", "^\\=end", { contains: [t], relevance: 10 }), e.COMMENT("^__END__", "\\n$")],
            ...
            l = {
                ...
                variants: [
                    ...
                    { begin: /<<[-~]?'?(\w+)(?:.|\n)*?\n\s*\1\b/, returnBegin: !0, contains: [{ begin: /<<[-~]?'?/ }, { begin: /\w+/, endSameAsBegin: !0, contains: [e.BACKSLASH_ESCAPE, r] }] },
                ],
            },
            ...
            e = [
                ...
                i,
                {
                    ...
                    illegal: /=/,
                    contains: [e.inherit(e.TITLE_MODE, { begin: "[A-Za-z_]\\w*(::\\w+)*(\\?|\\!)?" }), { begin: "<\\s*", contains: [{ begin: "(" + e.IDENT_RE + "::)?" + e.IDENT_RE }] }].concat(s),
                },
                { className: "function", beginKeywords: "def", end: "$|;", contains: [e.inherit(e.TITLE_MODE, { begin: n }), t].concat(s) },
                { begin: e.IDENT_RE + "::" },
        ...
        return (
            (r.contains = e),
            (t = [
                { begin: /^\s*=>/, starts: { end: "$", contains: (t.contains = e) } },
                { className: "meta", begin: "^([>?]>|[\\w#]+\\(\\w+\\):\\d+:\\d+>|(\\w+-)?\\d+\\.\\d+\\.\\d(p\\d+)?[^>]+>)", starts: { end: "$", contains: e } },
            ]),
    ...
    function T(e) {
        ...
        return {
            ...
            contains: [e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, a, { className: "symbol", begin: "'\\w[\\w\\d_]*(?!')" }, t, i, n, e.C_NUMBER_MODE, { className: "meta", begin: "@[A-Za-z]+" }],
        };
    }
    function k(e) {
    ...
    function R(e) {
        var n = {
            ...
            s = { className: "number", begin: "\\b([\\d_]+(\\.[\\deE_]+)?|0x[a-fA-F0-9_]+(\\.[a-fA-F0-9p_]+)?|0b[01_]+|0o[0-7_]+)\\b", relevance: 0 };
        return (
            (t.contains = [s]),
            {
                keywords: n,
                contains: [
                    ...
                    s,
                    {
                        ...
                        contains: [
                            ...
                            { begin: /</, end: />/ },
                            { className: "params", begin: /\(/, end: /\)/, endsParent: !0, keywords: n, contains: ["self", s, i, e.C_BLOCK_COMMENT_MODE, { begin: ":" }], illegal: /["']/ },
                        ],
                        illegal: /\[|%/,
                    },
                    { className: "class", beginKeywords: "struct protocol class extension enum", keywords: n, end: "\\{", excludeEnd: !0, contains: [e.inherit(e.TITLE_MODE, { begin: /[A-Za-z$_][\u00C0-\u02B80-9A-Za-z$_]*/ })] },
                    {
                        className: "meta",
                        begin:
    ...
    function D(e) {
        ...
        return {
            ...
            case_insensitive: !0,
            contains: [
                { className: "meta", begin: "<![a-z]", end: ">", relevance: 10, contains: [a, s, i, t, { begin: "\\[", end: "\\]", contains: [{ className: "meta", begin: "<![a-z]", end: ">", contains: [a, t, s, i] }] }] },
                ...
                { className: "tag", begin: "<style(?=\\s|>)", end: ">", keywords: { name: "style" }, contains: [r], starts: { end: "</style>", returnEnd: !0, subLanguage: ["css", "xml"] } },
                { className: "tag", begin: "<script(?=\\s|>)", end: ">", keywords: { name: "script" }, contains: [r], starts: { end: "</script>", returnEnd: !0, subLanguage: ["actionscript", "javascript", "handlebars", "xml"] } },
                { className: "tag", begin: "</?", end: "/?>", contains: [{ className: "name", begin: /[^\/><\s]+/, relevance: 0 }, r] },
            ],
        };
    }
    function L(e) {
    ...
    (e = function (t) {
            ...
            return (
                (function e(n, a) {
                    for (var t = n.firstChild; t; t = t.nextSibling)
                        3 === t.nodeType ? (a += t.nodeValue.length) : 1 === t.nodeType && (i.push({ event: "start", offset: a, node: t }), (a = e(t, a)), u(t).match(/br|hr|img|input/) || i.push({ event: "stop", offset: a, node: t }));
                    return a;
                })(e, 0),
                i
            );
        ...
        function _(e, n, a) {
                ...
                i +=
                    ...
                    g.map
                        .call(e.attributes, function (e) {
                            return " " + e.nodeName + '="' + S(e.value).replace(/"/g, "&quot;") + '"';
                        })
                        .join("") +
                    ">";
            }
            ...
            for (; e.length || n.length; ) {
                ...
                if (((i += S(a.substring(t, d[0].offset))), (t = d[0].offset), d === e)) {
                    for (s.reverse().forEach(o); c(d.splice(0, 1)[0]), (d = r()), d === e && d.length && d[0].offset === t; );
                    s.reverse().forEach(l);
        ...
        function T(t) {
            ...
            function i(i) {
                ...
                for (var n = 0; n < i.contains.length; n++) {
                    var t,
                        o = (t = i.contains[n]).beginKeywords ? "\\.?(?:" + t.begin + ")\\.?" : t.begin;
                    e(t, o);
                }
                i.terminator_end && e("end", i.terminator_end), i.illegal && e("illegal", i.illegal);
                var c = g(
                    (function (e, n) {
                        for (var a = /\[(?:[^\\\]]|\\.)*\]|\(\??|\\([1-9][0-9]*)|\\./, t = 0, i = "", s = 0; s < e.length; s++) {
                            ...
                            for (0 < s && (i += n), i += "("; 0 < l.length; ) {
                                ...
                                (i += l.substring(0, o.index)), (l = l.substring(o.index + o[0].length)), "\\" == o[0][0] && o[1] ? (i += "\\" + String(Number(o[1]) + r)) : ((i += o[0]), "(" == o[0] && t++);
                            }
                            i += ")";
                        }
                        return i;
        ...
        function k(n, e, t, a) {
            ...
            function r() {
                var e, n, a, t, i;
                if (!_.keywords) return S(E);
                for (a = "", e = 0, _.lexemesRe.lastIndex = 0, n = _.lexemesRe.exec(E); n; )
                    (a += S(E.substring(e, n.index))),
                        ...
                        (e = _.lexemesRe.lastIndex),
                        (n = _.lexemesRe.exec(E));
                return a + S(E.substr(e));
            }
            function l() {
                (p += (null != _.subLanguage
                    ? function () {
                          var e = "string" == typeof _.subLanguage;
                          if (e && !w[_.subLanguage]) return S(E);
            ...
            function c(e) {
                var n = e[0],
                    e = e.rule;
                return (
                    e && e.endSameAsBegin && (e.endRe = new RegExp(n.replace(/[-\/\\^$*+?.()|[\]{}]/g, "\\$&"), "m")),
                    e.skip ? (E += n) : (e.excludeBegin && (E += n), l(), e.returnBegin || e.excludeBegin || (E = n)),
                    o(e),
            ...
            function d(e) {
                ...
                if (a) {
                    e = _;
                    for (e.skip ? (E += n) : (e.returnEnd || e.excludeEnd || (E += n), l(), e.excludeEnd && (E = n)); _.className && (p += M), _.skip || _.subLanguage || (N += _.relevance), (_ = _.parent), _ !== a.parent; );
            ...
            function u(e, n) {
                ...
                if ("begin" == g.type && "end" == n.type && g.index == n.index && "" === a) return (E += i.slice(n.index, n.index + 1)), 1;
                if ("illegal" === g.type && "" === a) return (E += i.slice(n.index, n.index + 1)), 1;
                if ("begin" === (g = n).type) return c(n);
                if ("illegal" === n.type && !t) throw new Error('Illegal lexeme "' + a + '" for mode "' + (_.className || "<unnamed>") + '"');
                if ("end" === n.type) {
                    n = d(n);
                    if (null != n) return n;
                }
            ...
            var m = R(n);
            if (!m) throw (console.error(x.replace("{}", n)), new Error('Unknown language: "' + n + '"'));
            T(m);
            ...
            try {
                ...
                return { relevance: N, value: p, illegal: !1, language: n, top: _ };
            } catch (e) {
                if (e.message && -1 !== e.message.indexOf("Illegal")) return { illegal: !0, relevance: 0, value: S(i) };
                if (O) return { relevance: 0, value: S(i), language: n, top: _, errorRaised: e };
                throw e;
            }
        }
        function A(a, e) {
            ...
            var n,
                ...
                s = (function (e) {
                    ...
                    if (((s += e.parentNode ? e.parentNode.className : ""), (a = l.exec(s)))) {
                        var r = R(a[1]);
                        return r || (console.warn(x.replace("{}", a[1])), console.warn("Falling back to no-highlight mode for this block.", e)), r ? a[1] : "no-highlight";
                    }
                    for (n = 0, t = (s = s.split(/\s+/)).length; n < t; n++) if (c((i = s[n])) || R(i)) return i;
                })(e);
            c(s) ||
                ...
                (a.value = E(a.value)),
                (e.innerHTML = a.value),
                (e.className = ((t = e.className), (i = s), (s = a.language), (i = i ? r[i] : s), (s = [t.trim()]), t.match(/\bhljs\b/) || s.push("hljs"), -1 === t.indexOf(i) && s.push(i), s.join(" ").trim())),
        ...
        return (
            ...
            (t.registerLanguage = function (n, e) {
                ...
                try {
                    ...
                    if ((console.error("Language definition for '{}' could not be registered.".replace("{}", n)), !O)) throw e;
                    console.error(e), (a = v);
                }
                p((w[n] = a)),
            ...
            (t.COMMENT = function (e, n, a) {
                ...
                return a.contains.push(t.PHRASAL_WORDS_MODE), a.contains.push({ className: "doctag", begin: "(?:TODO|FIXME|NOTE|BUG|XXX):", relevance: 0 }), a;
            }),
            ...
            (t.REGEXP_MODE = { className: "regexp", begin: /\//, end: /\/[gimuy]*/, illegal: /\n/, contains: [t.BACKSLASH_ESCAPE, { begin: /\[/, end: /\]/, relevance: 0, contains: [t.BACKSLASH_ESCAPE] }] }),
        ...
        (function () {
            ...
            a.registerLanguage("asciidoc", t),
                ...
                [].slice.call(document.querySelectorAll("pre code.hljs")).forEach(function (e) {
                    a.highlightBlock(e);
                });
        })();
})();
